...
export async function attachCurrentFourSystemCli(inputs, minorVersion) {
  assert.ok(minorVersion === 1 || minorVersion === 2 || minorVersion === 3 || minorVersion === 4 || minorVersion === 5 || minorVersion === 6 || minorVersion === 7 || minorVersion === 8 || minorVersion === 9 || minorVersion === 10);
